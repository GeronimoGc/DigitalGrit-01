<div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarPages" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    Tienda Digital
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarPages">
                    ...
                    <hr>
                    <li class="dropright">
                        <a class="dropdown-item dropdown-toggle" href="#" id="pagesBlog" role="button"
                    ...
                    <li class="dropright">
                        <a class="dropdown-item dropdown-toggle" href="#" id="pagesShop" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Procesadores
                        </a>
                    ...
                    <li class="dropright">
                        <a class="dropdown-item dropdown-toggle" href="#" id="Placas_Base" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Placas Base
                        </a>
                        <div class="dropdown-menu" aria-labelledby="Placas_Base">
                            <a class="dropdown-item " href="#">
                                AMD
                            </a>
                            <a class="dropdown-item " href="#">
                    ...
                    <li class="dropright">
                        <a class="dropdown-item dropdown-toggle" href="#" id="Tarjetas_Graficas" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Tarjetas Graficas
                        </a>
                        <div class="dropdown-menu" aria-labelledby="Tarjetas_Graficas">
                            <a class="dropdown-item " href="#">
                                Nvidia
                            </a>
                            <a class="dropdown-item " href="#">
